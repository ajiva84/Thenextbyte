      ...
      <div className="row justify-content-xl-between justify-content-center">
        <div className="col-xl-4 col-lg-5 col-md-6">
          <div className="footer-widget widget_about me-md-5 wow fadeInUp delay-0-2s">
            ...
            <p>
            You can also follow us on social media to stay up-to-date on our latest products, services, and promotions.
            </p>
    ...
    <div className="footer-bottom mt-30 pt-25 pb-10">
      <div className="container">
        <div className="copyright-text text-center">
          <p>© Copyright 2023 TheNextByte. All right reserved</p>
        </div>
      </div>
    </div>
  </footer>
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="copyright-text text-center text-lg-start">
              <p>© Copyright 2022 TheNextByte. All right reserved</p>
            </div>
          </div>
          <div className="col-lg-6">
